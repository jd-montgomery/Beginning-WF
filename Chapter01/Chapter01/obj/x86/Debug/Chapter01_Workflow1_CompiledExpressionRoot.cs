namespace Chapter01 {
    ...
    public partial class Workflow1 : System.Activities.XamlIntegration.ICompiledExpressionRoot {
        ...
        public bool CanExecuteExpression(string expressionText, bool isReference, System.Collections.Generic.IList<System.Activities.LocationReference> locations, out int expressionId) {
            ...
            if (((isReference == true) 
                        && ((expressionText == "numberOfBells") 
                        && (Workflow1_TypedDataContext2.Validate(locations, true, 0) == true)))) {
                expressionId = 3;
                return true;
            }
            if (((isReference == false) 
                        && ((expressionText == "counter.ToString()") 
                        && (Workflow1_TypedDataContext2_ForReadOnly.Validate(locations, true, 0) == true)))) {
                expressionId = 4;
                return true;
            }
            ...
            if (((isReference == false) 
                        && ((expressionText == "counter <= numberOfBells") 
                        && (Workflow1_TypedDataContext2_ForReadOnly.Validate(locations, true, 0) == true)))) {
                expressionId = 8;
                return true;
            }
            if (((isReference == false) 
                        && ((expressionText == "\"The time is \" + DateTime.Now.ToString()") 
                        && (Workflow1_TypedDataContext2_ForReadOnly.Validate(locations, true, 0) == true)))) {
                expressionId = 9;
                return true;
            }
        ...
        private class Workflow1_TypedDataContext2 : Workflow1_TypedDataContext1 {
            ...
            protected override void GetValueTypeValues() {
                ...
                this.numberOfBells = ((int)(this.GetVariableValue((1 + locationsOffset))));
                base.GetValueTypeValues();
            }
            
            protected override void SetValueTypeValues() {
                this.SetVariableValue((0 + locationsOffset), this.counter);
                this.SetVariableValue((1 + locationsOffset), this.numberOfBells);
            ...
            public new static bool Validate(System.Collections.Generic.IList<System.Activities.LocationReference> locationReferences, bool validateLocationCount, int offset) {
                ...
                if (((locationReferences[(offset + 1)].Name != "numberOfBells") 
